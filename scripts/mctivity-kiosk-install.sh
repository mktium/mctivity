...
if [ "$PROFILE" = "axis-d-uservo" ] || [ "$PROFILE" = "axis-d-uservo-pv" ] || [ "$PROFILE" = "axis-d-uservo-combined" ] || [ "$PROFILE" = "axis-de-uservo-pv" ] || [ "$PROFILE" = "axis-de-uservo-gear" ] || [ "$PROFILE" = "axis-de-uservo-combined" ]; then
